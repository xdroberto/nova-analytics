...
export const users: UserRow[] = [
  {
    name: "Olivia Rhye",
    email: "olivia.rhye@novaanalytics.io",
    role: "Workspace Owner",
    status: "Active",
    team: "Platform",
    workspace: ["Nova Analytics", "Internal Tools"],
    joinedDate: "24 Jun 2024, 9:23 AM",
    lastActive: 0,
  },
  {
    name: "Phoenix Baker",
    email: "phoenix.baker@novaanalytics.io",
    role: "Admin",
    status: "Active",
    team: "Growth",
    workspace: ["Nova Analytics"],
    joinedDate: "15 Mar 2023, 2:45 PM",
    lastActive: 5,
  },
  {
    name: "Lana Steiner",
    email: "lana.steiner@novaanalytics.io",
    role: "Billing Admin",
    status: "Active",
    team: "Revenue",
    workspace: ["Web App"],
  ...
  {
    name: "Demi Wilkinson",
    email: "demi.wilkinson@novaanalytics.io",
    role: "Security Admin",
    status: "Locked",
    team: "Internal Tools",
    workspace: ["Nova Analytics", "Internal Tools"],
  ...
  {
    name: "Candice Wu",
    email: "candice.wu@novaanalytics.io",
    role: "Team Lead",
    status: "Active",
    team: "Customer Ops",
    workspace: ["Mobile"],
  ...
  {
    name: "Natali Craig",
    email: "natali.craig@novaanalytics.io",
    role: "Contributor",
  ...
  {
    name: "Orlando Diggs",
    email: "orlando.diggs@novaanalytics.io",
    role: "Read-only",
    status: "Deactivated",
    team: "Revenue",
    workspace: ["Web App"],
  ...
  {
    name: "Andi Lane",
    email: "andi.lane@novaanalytics.io",
    role: "Contributor",
    status: "Active",
    team: "People Ops",
    workspace: ["Nova Analytics", "Mobile"],
    joinedDate: "04 Nov 2022, 9:50 AM",
    lastActive: 12,
  },
  {
    name: "Kate Morrison",
    email: "kate.morrison@novaanalytics.io",
    role: "Admin",
    status: "Active",
    team: "Platform",
    workspace: ["Nova Analytics"],
  ...
  {
    name: "Ariana Decker",
    email: "ariana.decker@novaanalytics.io",
    role: "Contributor",
    status: "Active",
    team: "Growth",
    workspace: ["Nova Analytics"],
  ...
  {
    name: "Steven Tey",
    email: "steven.tey@novaanalytics.io",
    role: "Guest",
    status: "Pending invite",
    team: "Customer Ops",
    workspace: ["Mobile"],
  ...
  {
    name: "Lori Bryson",
    email: "lori.bryson@novaanalytics.io",
    role: "Billing Admin",
    status: "Active",
    team: "Finance",
    workspace: ["Web App"],
  ...
  {
    name: "Koray Okumus",
    email: "koray.okumus@novaanalytics.io",
    role: "Security Admin",
    status: "Active",
    team: "Internal Tools",
    workspace: ["Nova Analytics", "Internal Tools"],
  ...
  {
    name: "Mollie Hall",
    email: "mollie.hall@novaanalytics.io",
    role: "Contributor",
    status: "Deactivated",
    team: "Platform",
    workspace: ["Nova Analytics"],
  ...
  {
    name: "Rene Wells",
    email: "rene.wells@novaanalytics.io",
    role: "Team Lead",
    status: "Active",
    team: "Revenue",
    workspace: ["Web App"],
  ...
  {
    name: "Rylee Howard",
    email: "rylee.howard@novaanalytics.io",
    role: "Guest",
    status: "Locked",
    team: "Growth",
    workspace: ["Mobile"],
  ...
  {
    name: "Sienna Hewitt",
    email: "sienna.hewitt@novaanalytics.io",
    role: "Admin",
    status: "Active",
    team: "Internal Tools",
    workspace: ["Nova Analytics", "Internal Tools"],
  ...
  {
    name: "Noah Pierre",
    email: "noah.pierre@novaanalytics.io",
    role: "Contributor",
    status: "Active",
    team: "Platform",
    workspace: ["Nova Analytics"],
  ...
  {
    name: "Eve Lechner",
    email: "eve.lechner@novaanalytics.io",
    role: "Read-only",
    status: "Suspended",
    team: "Finance",
    workspace: ["Web App"],
  ...
  {
    name: "Mia Romberg",
    email: "mia.romberg@novaanalytics.io",
    role: "Billing Admin",
    status: "Pending invite",
    team: "Finance",
    workspace: ["Nova Analytics"],
  ...
  {
    name: "Nico Arendt",
    email: "nico.arendt@novaanalytics.io",
    role: "Contributor",
    status: "Active",
    team: "Customer Ops",
    workspace: ["Mobile", "Internal Tools"],
...
export const filters = {
  ...
  workspace: ["All", "Nova Analytics", "Web App", "Mobile", "Internal Tools"],
};
